...
\begin{abstract}
This is a half-assed\footnote{I haven't bothered with adding citations for related work and other such chores.}, wholly irreverent\footnote{I'm not afraid to editorialize in this report.}, probably offensive, yet hopefully methodologically sound technical report. It aims to answer the following research questions (RQs) about undergraduate students at the University of Oregon (UO) following some exploratory investigation:

\begin{itemize}
	\item RQ1: Has UO seen grade inflation?
	\item RQ2: Are academically high performing students more likely to be men or women at UO?
	\item RQ3: Which majors produce students with higher GPAs?
	\item RQ4: When considering students from Oregon, which geographic areas of the state produce academically high performing students? Similarly, which places don't produce high performing students? How does this production intersect with the racial and gender demographics of a student's community of origin?
\end{itemize}

It goes without saying that this work is not peer-reviewed, and like hell am I dragging some poor faculty member into my academic politicking to help look over my shoulder and constructively critique my methodology a priori, so there are likely many flaws in this work. That said, here are the takeaways (TA) from the exploratory investigation:

\begin{itemize}
	\item TA1: The percentage of full time enrolled students with term GPAs of 3.75 or above has increased from 7\% of total enrollment in Spring Term 2012 to 23\% in Spring Term 2022.
	\item TA2: Our findings suggest that women at UO are consistently more likely than men to be among the top performing students in the past decade. On average, women are overrepresented among top performing students by an additional 6\%, even when controlling for their slightly higher enrollment numbers.
	...
	\item TA4: We have an urban-rural divide and a racial gap in the places where our top performing in-state students are sourced from.
	\begin{itemize}
		\item There is a racial gap in zip codes which produce the top performers at UO. Zip codes in the top 50\% of Dean's List producers are $\sim$6\% more white than zip codes in the bottom 50\%.
		\item Rural areas are particularly unlikely to produce Dean's List students. Eastern Oregon fares worse than Western Oregon. 
		\item Of note is the Warm Springs Indian Reservation, which is a rural community of color. There hasn't been a single student from that community on the Dean's List in the past decade.
		\item Within the Willamette Valley, rural areas and smaller towns with comparatively higher proportions of kids of color are less likely to have students on the Dean's Lists. Getting more kids on the Dean's List from smaller towns and rural areas slightly north of Salem, as well as Multnomah county in areas east of I205, would likely go far in closing the geographical racial gap in the zip codes of UOs top performers.
	\end{itemize}
\end{itemize}
...
%\begin{enumerate}
%	\item IRB approval is an exercise in absurdity. See this Chronicle of Education article: \url{https://www.chronicle.com/article/the-abject-failure-of-irbs}
...
%	\item IRB approval is a boatload of paperwork, takes forever to get, and this research is all probably exempt anyway, even though it deals with identifiable human subjects, because all my data is already publicly available.
...
\begin{longtable}[c]{|c|c|c|c|c|}
	\caption{\parbox{\linewidth}{Number of students that made the Dean's List (i.e., had term GPAs of 3.75 or above) each term for the last decade. Included is the overall undergraduate enrollment for the term, and the percentage of students who made the Dean's list given overall enrollment.}}
	\label{tab:grade-inflation-table}\\
	\hline
	\textbf{Academic Year} & \textbf{Term} & \textbf{Count} & \textbf{Enrollment} & \textbf{Percentage of enrolled students on the Dean's List} \\ \hline
	\endhead
	%
...
\begin{figure}[H]
	\centering
	\includegraphics[width=\linewidth]{../visualizations/youth-per-capita-quartile-willammette}
	\includegraphics[width=0.8\linewidth]{../visualizations/youth-per-capita-quartile-pdx}
